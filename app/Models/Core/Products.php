...
class Products extends Model
{
	...
	public function paginator($request){
        ...
        if (isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id'])) {
            ...
            ->where('categories_status', '1')->simplePaginate($commonsetting['pagination']);
            ...
            ->where('is_current', '1')
            ->groupBy('products.products_id')->simplePaginate($commonsetting['pagination']);
        }
  ...
  public function getter(){
            ...
            //  }
              ...
              if (isset($_REQUEST['categories_id']) and !empty($_REQUEST['categories_id'])) {
                  ...
                  $products = $data->orderBy('products.products_id', 'DESC')->simplePaginate($commonsetting['pagination']);
